...
exports.createCourse = async (req, res) => {
  const { titulo, instructor, descripcion, syllabus } = req.body;
  const image = req.file; // Verificamos si se ha subido una imagen
  ...
  try {
    ...
    const newCourse = new Curso({
      ...
      syllabus: syllabus ? JSON.parse(syllabus) : [] // Parseamos el syllabus para asegurarnos que sea un array de objetos
    });
